...
/**
 * This class defines a RandomDropLayer - the Mongo Wongo Layer
 * 
 * @author Jose Mocito
 * @version 1.0
 */
public class RandomDropLayer extends Layer {

    /**
     * Creates a new EccoLayer.
     */
    public RandomDropLayer() {
    ...
    public Session createSession() {
        return new RandomDropSession(this);
    }
}
